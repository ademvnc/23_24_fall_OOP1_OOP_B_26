 ...
 * @file Box_It!.cpp
 * @brief This program demonstrates the usage of the Box class.
 * @details This program reads box information from the user and prints the information to standard output.
 * The program uses a class to store the box information.
 * @return 0 on successful execution.
 * @author ademvnc 
 * @date 10/08/2021
 * @version 1.0
 * @note This program is a solution to the sixteenth question of the HackerRank C++ Basic Certification Test.
 */
